...
{
    public class VerticalContextMenu : VerticalMenu<ClassicMenuOption, ClassicButtonMenuItem>
    {
        private enum Origin
        {
            RightBottom,
        ...
        [Header("Components")]
        [SerializeField] private CompWrapper<RectTransform> _clickerBlocker = "./ClickBlocker";
        [SerializeField] private CompWrapper<CompAnyPlayable> _playable = "./Panel";
        ...
        {
            LogObj.Default.Warn("This show method should not be called. Use Show(Vector2, RectTransform) instead.");
            Show(Vector2.zero, null);
        }
        ...
        private void PerformHide(bool playAnim)
        {
        ...
        protected override void SetCurrentOption(ClassicMenuOption option, bool invokeCallbacks)
        {
            base.SetCurrentOption(option, invokeCallbacks);
            Hide();
        }
        ...
        private void AdjustClickBlocker()
        {
            var rootCanvas = gameObject.GetRootCanvas();
            if (rootCanvas == null)
            {
            ...
            _clickerBlocker.Comp.FitRectTransformTo(rootCanvas.GetComponent<RectTransform>());
        }
        ...
        private void PlayAnimation(bool bShow)
        {
            ...
            // Reset panels
            _panel.Comp.localScale = Vector3.one;
            _panel.Comp.localEulerAngles = Vector3.zero;
            ...
            _playable.NullableComp?.Play(animationStr, null);
        }
    }
}
